...
AsyncAPI-first service repository for the Arcadia Editions fulfillment contracts.
...
- [domain-model.zdl](./domain-model.zdl): source of truth for the fulfillment aggregate, lifecycle, commands, and events
